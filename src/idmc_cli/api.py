...
class InformaticaCloudAPI:
    ...
    def getAgentGroupProps(self, id=None, name=None, overridden=None, debug=False):
        ...
        while True:
            ...
            if overridden:
                ...
                url = f'https://{ self.pod }.{ self.region }.informaticacloud.com/saas/api/v2/runtimeEnvironment/{ quote(id) }/configs/details'
            headers = { 'Accept': 'application/json', 'Content-Type': 'application/json', 'icSessionId': self.session_id }
            r = requests.get(url, headers=headers)
